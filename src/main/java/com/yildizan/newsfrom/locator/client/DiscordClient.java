...
import com.yildizan.newsfrom.locator.configuration.FeignConfiguration;
...
@FeignClient(name = "discordClient", url = "${discord.webhook.url}", configuration = FeignConfiguration.class)
